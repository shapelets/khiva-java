...
public class StatisticsTest {
    ...
    public void testCovarianceUnbiased() throws Exception {
        ...
        try(Array arrayOfTimeSeries = new Array(timeSeries, dims)) {
            float[] result = Statistics.covariance(arrayOfTimeSeries).getData();
    ...
    public void testCovarianceBiased() throws Exception {
        ...
        long[] dims = {3, 3, 1, 1};
        try(Array arrayOfTimeSeries = new Array(timeSeries, dims)) {
            float[] result = Statistics.covariance(arrayOfTimeSeries, false).getData();
    ...
    public void testKurtosis() throws Exception {
        ...
        long[] dims = {6, 2, 1, 1};
        try(Array arrayOfTimeSeries = new Array(timeSeries, dims)) {
            float[] result = Statistics.kurtosis(arrayOfTimeSeries).getData();
    ...
    public void testLjungBox() throws Exception {
        ...
        try(Array arrayOfTimeSeries = new Array(timeSeries, dims)) {
            ...
            float[] result = Statistics.ljungBox(arrayOfTimeSeries, 3).getData();
    ...
    public void testMoment() throws Exception {
        ...
        long[] dims = {6, 2, 1, 1};
        try(Array arrayOfTimeSeries = new Array(timeSeries, dims)) {
            float[] result = Statistics.moment(arrayOfTimeSeries, 2).getData();
    ...
    public void testQuantile() throws Exception {
        ...
        float[] q = {0.1f, 0.2f};
        long[] dimsQ = {2, 1, 1, 1};
        try(Array arrayOfTimeSeries = new Array(timeSeries, dims); Array qa = new Array(q, dimsQ)) {

            float[] result = Statistics.quantile(arrayOfTimeSeries, qa).getData();
    ...
    public void testQuantileCut2() throws Exception {
        ...
        try(Array arrayOfTimeSeries = new Array(timeSeries, dims)) {
            ...
            float[] result = Statistics.quantilesCut(arrayOfTimeSeries, 2).getData();
    ...
    public void testQuantileCut3() throws Exception {
        ...
        try(Array arrayOfTimeSeries = new Array(timeSeries, dims)) {
            ...
            float[] result = Statistics.quantilesCut(arrayOfTimeSeries, 3).getData();
    ...
    public void testQuantileCut7() throws Exception {
        ...
        try(Array arrayOfTimeSeries = new Array(timeSeries, dims)) {
            ...
            float[] result = Statistics.quantilesCut(arrayOfTimeSeries, 7).getData();
    ...
    public void testSampleStdev() throws Exception {
        ...
        long[] dims = {6, 2, 1, 1};
        try(Array arrayOfTimeSeries = new Array(timeSeries, dims)) {
            float[] result = Statistics.sampleStdev(arrayOfTimeSeries).getData();
    ...
    public void testSkewness() throws Exception {
        ...
        long[] dims = {6, 2, 1, 1};
        try (Array arrayOfTimeSeries = new Array(timeSeries, dims)) {
            float[] result = Statistics.skewness(arrayOfTimeSeries).getData();
