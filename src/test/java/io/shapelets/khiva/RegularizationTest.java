...
public class RegularizationTest {
    ...
    public void testGroupBySingleColumn() throws Exception {
        ...
        long[] dims = {6, 2, 1, 1};
        try (Array a = new Array(tss, dims); Array b = Regularization.groupBy(a, 0)) {
    ...
    public void testGroupByDoubleKeyColumn() throws Exception {
        ...
        long[] dims = {6, 3, 1, 1};
        try (Array a = new Array(tss, dims); Array b = Regularization.groupBy(a, 0, 2)) {
            double[] result = b.getData();
            double[] expected = {0, 3, 1, 2};
            assertArrayEquals(result, expected, DELTA);
        }
    ...
    public void testGroupByDoubleKeyDoubleValueColumn() throws Exception {
        ...
        long[] dims = {5, 4, 1, 1};
        try (Array a = new Array(tss, dims); Array b = Regularization.groupBy(a, 0, 2, 2)) {
            double[] result = b.getData();
